...
import { MoveSlotXYBody, MoveSlotDefaultBody, MoveSlotEnumBody, MoveSlotRangeBody, MoveSlotFilterBody, MoveSlotTransferBody, MoveSlotRampBody, MoveSlotDialBody, MoveSlotNumericBody } from './move-slots';
