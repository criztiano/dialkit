        ...
        h('div', { class: 'dialkit-timeline-row dialkit-timeline-ruler-row' }, [
          ...
          h('div', {
            ...
            ...(() => {
              ...
              return [
                h('div', { key: 'loop-dim-before', class: 'dialkit-timeline-loop-dim', style: { left: '0px', width: `${Math.max(0, left)}px` } }),
                h('div', { key: 'loop-dim-after', class: 'dialkit-timeline-loop-dim', style: { left: `${left + width}px`, right: '0px' } }),
                h('div', { key: 'loop-band', class: 'dialkit-timeline-loop-band', 'data-live': loopDrag.value ? 'true' : undefined, style: { left: `${left}px`, width: `${width}px` } }),
              ];
            })(),
