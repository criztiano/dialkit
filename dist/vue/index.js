...
var CurveComposer = defineComponent21({
  ...
  setup(props) {
    ...
    const W = computed5(() => props.width);
    const laneH = computed5(() => props.height);
    const driverH = computed5(() => props.driver ? Math.round(props.height * DRIVER_FRAC) : 0);
    const totalH = computed5(() => laneH.value + (props.driver ? GAP + driverH.value : 0));
    const mainRect = computed5(() => ({ x: 0, y: 0, w: W.value, h: laneH.value }));
    const driverRect = computed5(
    ...
    const diagonal = (rect, span, key) => h21("line", {
      key,
    ...
    return () => {
      ...
      children.push(
        props.segments.map((seg, i) => {
          ...
          return h21("g", { key: `seg-${i}` }, [
            ...
            h21("path", { class: "dialkit-cc-curve", d: curvePath(seg, main, span) }),
            h21(
              "text",
      ...
      if (dr) {
        ...
        children.push(
          h21("path", { class: "dialkit-cc-curve dialkit-cc-curve-driver", d: curvePath(props.driver, dr, [0, 1]) })
        );
        children.push(
