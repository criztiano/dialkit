        ...
        (0, import_vue11.h)("div", { class: "dialkit-gradient-toolbar" }, [
          (0, import_vue11.h)("button", {
            ...
            (0, import_vue11.h)(
              ...
              ICON_GRIP.map((c) => (0, import_vue11.h)("circle", { cx: c.cx, cy: c.cy, r: "1.5" }))
            )
          ]),
...
var RangeSlider = (0, import_vue13.defineComponent)({
  ...
  setup(props, { emit }) {
    ...
    const decimals = (0, import_vue13.computed)(() => decimalsForStep2(step.value));
...
var Slider = (0, import_vue16.defineComponent)({
  ...
  setup(props, { emit }) {
    ...
    const displayValue = (0, import_vue16.computed)(() => props.value.toFixed(decimalsForStep2(step.value)));
    let pointerDownPos = null;
    let isClickFlag = true;
    let wrapperRect = null;
    let scaleVal = 1;
...
var XYPad = (0, import_vue23.defineComponent)({
  ...
  emits: ["change"],
  setup(props, { emit }) {
    const xAxis = (0, import_vue23.computed)(() => resolveAxis(props.x));
    const yAxis = (0, import_vue23.computed)(() => resolveAxis(props.y));
    ...
    return () => (0, import_vue26.h)("div", { class: "dialkit-preset-manager" }, [
      (0, import_vue26.h)("button", {
        ...
        (0, import_vue26.h)(import_motion_v7.motion.svg, {
          ...
          transition: { type: "spring", visualDuration: 0.2, bounce: 0.15 }
        }, [(0, import_vue26.h)("path", { d: ICON_CHEVRON })])
      ]),
            ...
            ...props.presets.map((preset) => (0, import_vue26.h)("div", {
              ...
              ...preset.deletable ?? true ? [(0, import_vue26.h)("button", {
                ...
                (0, import_vue26.h)("svg", {
                  ...
                  "stroke-linecap": "round",
                  "stroke-linejoin": "round"
                }, ICON_TRASH.map((d) => (0, import_vue26.h)("path", { d })))
              ])] : []
            ]))
          ])] : []
        })
      ...
      const toolbarNode = (0, import_vue27.h)(import_vue27.Fragment, null, [
        (0, import_vue27.h)(import_motion_v8.motion.button, {
          ...
          (0, import_vue27.h)("svg", {
            ...
            "stroke-linecap": "round",
            "stroke-linejoin": "round"
          }, ICON_ADD_PRESET.map((d) => (0, import_vue27.h)("path", { d })))
        ]),
    ...
    return () => {
      ...
      return (0, import_vue28.h)("button", {
        ...
        (0, import_vue28.h)(
          ...
          ICON_TIMELINE.map((path) => (0, import_vue28.h)("path", { d: path, fill: "currentColor" }))
        )
      ]);
    };
  }
...
var DialTimeline = (0, import_vue32.defineComponent)({
  ...
  setup(props) {
    const timelines = (0, import_vue32.ref)(TimelineStore.getTimelines());
    const dockVisible = (0, import_vue32.ref)(TimelineUiStore.getVisible());
...
var PlayPauseButton = (0, import_vue32.defineComponent)({
  ...
  setup(props) {
    const playing = (0, import_vue32.ref)(TimelineStore.getTransport(props.id).playing);
    let unsubscribe;
    (0, import_vue32.onMounted)(() => {
    ...
    return () => {
      ...
      const icon = playing.value ? (0, import_vue32.h)(
        ...
        ICON_PAUSE.map((path) => (0, import_vue32.h)("path", { d: path, fill: "currentColor" }))
  ...
  setup(props) {
    return () => (0, import_vue32.h)("button", {
      ...
      (0, import_vue32.h)(
        "svg",
        { viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true" },
        ICON_REPLAY.map((path) => (0, import_vue32.h)("path", { d: path, fill: "currentColor" }))
      )
    ]);
  }
});
...
var TimelineOverview = (0, import_vue32.defineComponent)({
  ...
  setup(props) {
    const time = (0, import_vue32.ref)(TimelineStore.getTransport(props.id).time);
    let scrub = null;
    let unsubscribe;
    (0, import_vue32.onMounted)(() => {
      unsubscribe = TimelineStore.subscribe(props.id, () => {
        ...
        (0, import_vue32.h)("div", { class: "dialkit-timeline-actions" }, [
          (0, import_vue32.h)("button", {
            ...
            (0, import_vue32.h)(
              ...
              ICON_LOOP.map((d) => (0, import_vue32.h)("path", { d }))
            )
          ]),
          ...
          (0, import_vue32.h)("button", { class: "dialkit-toolbar-add", title: "Add timeline version", "aria-label": "Add timeline version", onClick: handleAddPreset }, [
            (0, import_vue32.h)(
              ...
              ICON_ADD_PRESET.map((path) => (0, import_vue32.h)("path", { d: path }))
            )
          ]),
          ...
          (0, import_vue32.h)("button", {
            ...
            copied.value ? (0, import_vue32.h)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", style: iconStyle }, [(0, import_vue32.h)("path", { d: ICON_CHECK })]) : (0, import_vue32.h)("svg", { viewBox: "0 0 24 24", fill: "none", style: iconStyle }, [
              (0, import_vue32.h)("path", { d: ICON_CLIPBOARD.board, stroke: "currentColor", "stroke-width": "2", "stroke-linejoin": "round" }),
              (0, import_vue32.h)("path", { d: ICON_CLIPBOARD.sparkle, fill: "currentColor" }),
              (0, import_vue32.h)("path", { d: ICON_CLIPBOARD.body, stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })
            ])
          ])]),
          (0, import_vue32.h)("button", {
...
function chevronIcon() {
  return (0, import_vue32.h)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2.5", "stroke-linecap": "round", "stroke-linejoin": "round" }, [
    (0, import_vue32.h)("path", { d: ICON_CHEVRON })
  ]);
}
...
var CurveComposer = (0, import_vue38.defineComponent)({
  ...
  setup(props) {
    ...
    const layout = (0, import_vue38.computed)(() => composerLayout(props.width, props.height, props.driver != null));
    ...
    const samplers = (0, import_vue38.computed)(() => buildSamplers(composition.value));
    let raf = 0;
