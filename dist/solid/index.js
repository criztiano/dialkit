...
var _tmpl$21 = /* @__PURE__ */ _$template13(`<div class=dialkit-module><div class=dialkit-module-header><span class=dialkit-module-title></span><div class=dialkit-module-switch></div></div><div class=dialkit-module-collapse><div class=dialkit-module-collapse-clip><div class=dialkit-module-inner>`);
var ENABLE_OPTIONS = [{
  value: "off",
  label: "Off"
}, {
...
function Module(props) {
  return (() => {
    ...
    _$insert13(_el$3, () => props.title);
    _$insert13(_el$4, _$createComponent12(SegmentedControl, {
    ...
    _$insert13(_el$7, () => props.children);
    _$effect12(() => _$setAttribute10(_el$5, "data-open", props.enabled));
    return _el$;
  })();
}
...
var _tmpl$30 = /* @__PURE__ */ _$template14(`<div class=dialkit-button-group>`);
var _tmpl$210 = /* @__PURE__ */ _$template14(`<button class=dialkit-button>`);
function ButtonGroup(props) {
  return (() => {
    var _el$ = _tmpl$30();
    _$insert14(_el$, _$createComponent13(For6, {
      get each() {
...
import { createSignal as createSignal12, mergeProps, onCleanup as onCleanup10, onMount as onMount9, Show as Show9 } from "solid-js";
...
// src/solid/components/WaveformVisualization.tsx
var _tmpl$31 = /* @__PURE__ */ _$template15(`<button type=button aria-label="Zoom out"><svg viewBox="0 0 16 16"fill=none><path d="M3.5 8h9"stroke=currentColor stroke-width=1.6 stroke-linecap=round>`);
var _tmpl$211 = /* @__PURE__ */ _$template15(`<div class=dialkit-waveform-zoom><button type=button aria-label="Zoom in"><svg viewBox="0 0 16 16"fill=none><path d="M8 3.5v9M3.5 8h9"stroke=currentColor stroke-width=1.6 stroke-linecap=round>`);
var _tmpl$39 = /* @__PURE__ */ _$template15(`<div class=dialkit-waveform-viz-wrap><canvas class=dialkit-waveform-viz>`);
function WaveformVisualization(props) {
  ...
  const [zoom, setZoom] = createSignal12(1);
  let canvasEl;
  onMount9(() => {
    if (!canvasEl) return;
    ...
    onCleanup10(() => engine.destroy());
  });
  const framingLoop = () => p.autoZoomOnLoop && !!p.loop;
  return (() => {
    var _el$ = _tmpl$39(), _el$2 = _el$.firstChild;
    var _ref$ = canvasEl;
    typeof _ref$ === "function" ? _$use8(_ref$, _el$2) : canvasEl = _el$2;
    _$insert15(_el$, _$createComponent14(Show9, {
      get when() {
        return !framingLoop();
      },
      get children() {
        var _el$3 = _tmpl$211(), _el$5 = _el$3.firstChild;
        _$insert15(_el$3, _$createComponent14(Show9, {
          get when() {
            return zoom() > 1;
          },
          get children() {
        ...
        _$effect13(() => _el$5.disabled = zoom() >= WAVEFORM_MAX_ZOOM);
        return _el$3;
      }
    }), null);
    _$effect13((_p$) => {
      var _v$ = `${p.width}px`, _v$2 = `${p.width}px`, _v$3 = `${p.height}px`;
      _v$ !== _p$.e && _$setStyleProperty5(_el$, "width", _p$.e = _v$);
      _v$2 !== _p$.t && _$setStyleProperty5(_el$2, "width", _p$.t = _v$2);
      _v$3 !== _p$.a && _$setStyleProperty5(_el$2, "height", _p$.a = _v$3);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
import { createMemo as createMemo2, createSignal as createSignal13, For as For7, mergeProps as mergeProps2, onCleanup as onCleanup11, onMount as onMount10, Show as Show10 } from "solid-js";
...
var _tmpl$62 = /* @__PURE__ */ _$template16(`<svg><line class=dialkit-cc-boundary></svg>`, false, true, false);
var _tmpl$72 = /* @__PURE__ */ _$template16(`<svg><rect class=dialkit-cc-lane rx=8></svg>`, false, true, false);
var _tmpl$82 = /* @__PURE__ */ _$template16(`<svg><rect class=dialkit-cc-seg-hover x=0 rx=8></svg>`, false, true, false);
var _tmpl$92 = /* @__PURE__ */ _$template16(`<svg><path class="dialkit-cc-curve dialkit-cc-curve-driver"></svg>`, false, true, false);
var _tmpl$0 = /* @__PURE__ */ _$template16(`<svg><text class=dialkit-cc-label>driver \xB7 </svg>`, false, true, false);
var _tmpl$1 = /* @__PURE__ */ _$template16(`<svg><line class=dialkit-cc-playhead x1=0 x2=0></svg>`, false, true, false);
var _tmpl$102 = /* @__PURE__ */ _$template16(`<svg><line class=dialkit-cc-diagonal></svg>`, false, true, false);
function CurveComposer(props) {
  ...
  let drag = null;
  const [hover, setHover] = createSignal13(null);
  onMount10(() => {
    let raf = 0;
    ...
    raf = requestAnimationFrame(tick);
    onCleanup11(() => cancelAnimationFrame(raf));
  });
  const hitLayout = () => {
    const dr = driverRect();
    return {
  ...
  return (() => {
    ...
    var _ref$ = svgEl;
    typeof _ref$ === "function" ? _$use9(_ref$, _el$2) : svgEl = _el$2;
    _$insert16(_el$2, _$createComponent15(For7, {
      ...
      children: (g) => (() => {
        ...
        _$effect14((_p$) => {
          ...
          _v$16 !== _p$.e && _$setAttribute11(_el$6, "x1", _p$.e = _v$16);
          _v$17 !== _p$.t && _$setAttribute11(_el$6, "y1", _p$.t = _v$17);
          _v$18 !== _p$.a && _$setAttribute11(_el$6, "x2", _p$.a = _v$18);
          _v$19 !== _p$.o && _$setAttribute11(_el$6, "y2", _p$.o = _v$19);
          return _p$;
        }, {
          e: void 0,
          t: void 0,
        ...
        return (() => {
          ...
          return (() => {
            ...
            _$effect14((_p$) => {
              ...
              _v$20 !== _p$.e && _$setAttribute11(_el$7, "x", _p$.e = _v$20);
              _v$21 !== _p$.t && _$setAttribute11(_el$7, "y", _p$.t = _v$21);
              _v$22 !== _p$.a && _$setAttribute11(_el$7, "width", _p$.a = _v$22);
              _v$23 !== _p$.o && _$setAttribute11(_el$7, "height", _p$.o = _v$23);
              return _p$;
            }, {
              e: void 0,
              t: void 0,
      ...
      children: (bx, i) => {
        ...
        return (() => {
          ...
          _$effect14((_p$) => {
            ...
            _v$35 !== _p$.e && _$setAttribute11(_el$11, "data-active", _p$.e = _v$35);
            _v$36 !== _p$.t && _$setAttribute11(_el$11, "x1", _p$.t = _v$36);
            _v$37 !== _p$.a && _$setAttribute11(_el$11, "y1", _p$.a = _v$37);
            _v$38 !== _p$.o && _$setAttribute11(_el$11, "x2", _p$.o = _v$38);
            _v$39 !== _p$.i && _$setAttribute11(_el$11, "y2", _p$.i = _v$39);
            return _p$;
          }, {
            e: void 0,
            t: void 0,
    ...
    typeof _ref$2 === "function" ? _$use9(_ref$2, _el$4) : seriesPlayheadEl = _el$4;
    var _ref$3 = seriesDotEl;
    typeof _ref$3 === "function" ? _$use9(_ref$3, _el$5) : seriesDotEl = _el$5;
    _$insert16(_el$2, _$createComponent15(Show10, {
      get when() {
        return driverRect();
      },
      children: (dr) => [(() => {
        ...
        _$effect14((_p$) => {
          ...
          _v$40 !== _p$.e && _$setAttribute11(_el$12, "x", _p$.e = _v$40);
          _v$41 !== _p$.t && _$setAttribute11(_el$12, "y", _p$.t = _v$41);
          _v$42 !== _p$.a && _$setAttribute11(_el$12, "width", _p$.a = _v$42);
          _v$43 !== _p$.o && _$setAttribute11(_el$12, "height", _p$.o = _v$43);
          return _p$;
        }, {
          e: void 0,
          t: void 0,
        ...
        get children() {
          ...
          _$effect14((_p$) => {
            ...
            _v$44 !== _p$.e && _$setAttribute11(_el$13, "y", _p$.e = _v$44);
            _v$45 !== _p$.t && _$setAttribute11(_el$13, "width", _p$.t = _v$45);
            _v$46 !== _p$.a && _$setAttribute11(_el$13, "height", _p$.a = _v$46);
            return _p$;
          }, {
            e: void 0,
            t: void 0,
        ...
        return (() => {
          ...
          _$effect14((_p$) => {
            ...
            _v$56 !== _p$.e && _$setAttribute11(_el$19, "x1", _p$.e = _v$56);
            _v$57 !== _p$.t && _$setAttribute11(_el$19, "y1", _p$.t = _v$57);
            _v$58 !== _p$.a && _$setAttribute11(_el$19, "x2", _p$.a = _v$58);
            _v$59 !== _p$.o && _$setAttribute11(_el$19, "y2", _p$.o = _v$59);
            return _p$;
          }, {
            e: void 0,
            t: void 0,
        ...
        var _el$14 = _tmpl$92();
        _$effect14(() => _$setAttribute11(_el$14, "d", curvePath(p.driver, dr(), [0, 1], W())));
        return _el$14;
      })(), (() => {
        var _el$15 = _tmpl$0(), _el$16 = _el$15.firstChild;
        _$insert16(_el$15, () => p.driver.type, null);
        _$effect14((_p$) => {
          var _v$47 = W() * 0.5, _v$48 = dr().y + 13;
          _v$47 !== _p$.e && _$setAttribute11(_el$15, "x", _p$.e = _v$47);
          _v$48 !== _p$.t && _$setAttribute11(_el$15, "y", _p$.t = _v$48);
          return _p$;
        }, {
          e: void 0,
          t: void 0
        ...
        typeof _ref$4 === "function" ? _$use9(_ref$4, _el$17) : driverPlayheadEl = _el$17;
        _$effect14((_p$) => {
          var _v$49 = dr().y, _v$50 = dr().y + dr().h, _v$51 = p.playheadColor;
          _v$49 !== _p$.e && _$setAttribute11(_el$17, "y1", _p$.e = _v$49);
          _v$50 !== _p$.t && _$setAttribute11(_el$17, "y2", _p$.t = _v$50);
          _v$51 !== _p$.a && _$setStyleProperty6(_el$17, "stroke", _p$.a = _v$51);
          return _p$;
        }, {
          e: void 0,
          t: void 0,
    ...
    _$effect14((_p$) => {
      ...
      _v$2 !== _p$.t && _$setAttribute11(_el$2, "viewBox", _p$.t = _v$2);
      _v$3 !== _p$.a && _$setAttribute11(_el$2, "width", _p$.a = _v$3);
      _v$4 !== _p$.o && _$setAttribute11(_el$2, "height", _p$.o = _v$4);
      _v$5 !== _p$.i && _$setStyleProperty6(_el$2, "width", _p$.i = _v$5);
      _v$6 !== _p$.n && _$setStyleProperty6(_el$2, "height", _p$.n = _v$6);
      _v$7 !== _p$.s && _$setStyleProperty6(_el$2, "cursor", _p$.s = _v$7);
      _v$8 !== _p$.h && _$setStyleProperty6(_el$2, "color", _p$.h = _v$8);
      _v$9 !== _p$.r && _$setAttribute11(_el$3, "x", _p$.r = _v$9);
      _v$0 !== _p$.d && _$setAttribute11(_el$3, "y", _p$.d = _v$0);
      _v$1 !== _p$.l && _$setAttribute11(_el$3, "width", _p$.l = _v$1);
      _v$10 !== _p$.u && _$setAttribute11(_el$3, "height", _p$.u = _v$10);
      _v$11 !== _p$.c && _$setAttribute11(_el$4, "y1", _p$.c = _v$11);
      _v$12 !== _p$.w && _$setAttribute11(_el$4, "y2", _p$.w = _v$12);
      _v$13 !== _p$.m && _$setStyleProperty6(_el$4, "stroke", _p$.m = _v$13);
      _v$14 !== _p$.f && _$setAttribute11(_el$5, "cy", _p$.f = _v$14);
      _v$15 !== _p$.y && _$setStyleProperty6(_el$5, "fill", _p$.y = _v$15);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
_$delegateEvents11(["pointerdown", "pointermove", "pointerup", "dblclick"]);
export {
  ButtonGroup,
  ColorControl,
  CurveComposer,
