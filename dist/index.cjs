...
function PresenceMotionDiv({ divRef, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_react10.motion.div, { ref: divRef, ...props });
}
...
function SelectControl({ label, value, options, onChange }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "dialkit-select-row", children: [
    ...
    portalTarget && (0, import_react_dom.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react12.AnimatePresence, { children: isOpen && pos && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        PresenceMotionDiv,
        {
          divRef: dropdownRef,
...
function SwatchControl({ label, value, options, onChange }) {
  ...
  const [highlight, setHighlight] = (0, import_react16.useState)(-1);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "dialkit-select-row", children: [
    ...
    portalTarget && (0, import_react_dom2.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_react17.AnimatePresence, { children: isOpen && pos && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
        PresenceMotionDiv,
        {
          divRef: dropdownRef,
          className: "dialkit-select-dropdown",
...
function ListControl({ label, value, itemTypes, addLabel, maxItems, onChange, onEvent }) {
  const idCounter = (0, import_react18.useRef)(0);
  const mkId = () => `li-${idCounter.current++}`;
  const [ids, setIds] = (0, import_react18.useState)(() => value.map(mkId));
  const [picking, setPicking] = (0, import_react18.useState)(false);
  const armedRef = (0, import_react18.useRef)(null);
  const [dragIndex, setDragIndex] = (0, import_react18.useState)(null);
...
function PresetManager({ panelId, presets, activePresetId, onAdd }) {
  ...
  const [pos, setPos] = (0, import_react19.useState)({ top: 0, left: 0, width: 0 });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "dialkit-preset-manager", children: [
    ...
    (0, import_react_dom3.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_react20.AnimatePresence, { children: isOpen && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
        PresenceMotionDiv,
        {
          divRef: dropdownRef,
...
function Panel({ panel, defaultOpen = true, inline = false }) {
  ...
  const [isPanelOpen, setIsPanelOpen] = (0, import_react21.useState)(defaultOpen);
  const shortcutCtx = (0, import_react21.useContext)(ShortcutContext);
  const hasShortcuts = Object.keys(panel.shortcuts).length > 0;
  const values = (0, import_react21.useSyncExternalStore)(
  ...
  const toolbar = /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      import_react22.motion.button,
      {
        ...
        whileTap: { scale: 0.9 },
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { position: "relative", width: 16, height: 16 }, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react22.AnimatePresence, { initial: false, mode: "wait", children: copied ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
...
function DialRoot({ position = "top-right", defaultOpen = true, mode = "popover", theme = "system", productionEnabled = isDevDefault }) {
  ...
  const [panels, setPanels] = (0, import_react23.useState)([]);
  const [mounted, setMounted] = (0, import_react23.useState)(false);
  const inline = mode === "inline";
  const panelRef = (0, import_react23.useRef)(null);
  const [dragOffset, setDragOffset] = (0, import_react23.useState)(null);
  const [activePosition, setActivePosition] = (0, import_react23.useState)(position);
  const lastDragOffset = (0, import_react23.useRef)(null);
  const draggingRef = (0, import_react23.useRef)(false);
  const dragStartRef = (0, import_react23.useRef)(null);
  const didDragRef = (0, import_react23.useRef)(false);
  ...
  const handlePointerUp = (0, import_react23.useCallback)((e) => {
...
function WaveformVisualization({
  ...
  const runtimeRef = (0, import_react24.useRef)(null);
  runtimeRef.current = {
    buffer,
    progress,
    getProgress,
...
function CurveComposer({
  ...
  const composition = (0, import_react25.useMemo)(
    () => ({ segments, driver, direction }),
    [segments, driver, direction]
  );
  const samplers = (0, import_react25.useMemo)(() => buildSamplers(composition), [composition]);
  const liveRef = (0, import_react25.useRef)({ composition, samplers, getPhase, phase, mode, triggerSteps });
  liveRef.current = { composition, samplers, getPhase, phase, mode, triggerSteps };
  const onTriggerRef = (0, import_react25.useRef)(onTrigger);
  onTriggerRef.current = onTrigger;
  const svgRef = (0, import_react25.useRef)(null);
  const seriesPlayheadRef = (0, import_react25.useRef)(null);
  const seriesDotRef = (0, import_react25.useRef)(null);
  const driverPlayheadRef = (0, import_react25.useRef)(null);
  const prevTrigValue = (0, import_react25.useRef)(Number.NaN);
  const [drag, setDrag] = (0, import_react25.useState)(null);
  const [hover, setHover] = (0, import_react25.useState)(null);
  const dragRef = (0, import_react25.useRef)(null);
...
function ShortcutsMenu({ panelId }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(import_jsx_runtime26.Fragment, { children: [
    ...
    (0, import_react_dom5.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(import_react27.AnimatePresence, { children: isOpen && /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)(
        PresenceMotionDiv,
        {
          divRef: dropdownRef,
