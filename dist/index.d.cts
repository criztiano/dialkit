 ...
 */
type MoveSlotKind = 'default' | 'value' | 'icon' | 'curve' | 'enum' | 'xy' | 'range' | 'filter' | 'env' | 'scope';
 ...
 */
declare function MoveSlotEnvBody({ points, stages, }: {
 ...
 */
declare function MoveSlotScopeBody({ label, caption, children, }: {
    label: string;
    caption: ReactNode;
...
declare const MOVE_SLOT_LIBRARY: {
    ...
    readonly scope: {
        readonly description: "a display, not a control: the modulator’s live signal";
